    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy",
                            NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Provider = table.Column<int>("integer", nullable: false),
                    ExternalUserId = table.Column<string>("character varying(20)", maxLength: 20, nullable: false),
                    Code = table.Column<int>("integer", maxLength: 50, nullable: false),
                    SendDate = table.Column<DateTime>("timestamp without time zone", nullable: false),
                    IsSend = table.Column<bool>("boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    UserId = table.Column<int>("integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy",
                            NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CitizenId = table.Column<long>("bigint", nullable: false),
                    ...
                    Address = table.Column<string>("character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                "IX_MobileLogins_ExternalUserId_Provider",
                "MobileLogins",
                new[] {"ExternalUserId", "Provider"});
